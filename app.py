...
# App Title
st.title("🌎 Austria Wikipedia Sentiment Analysis")
st.subheader("Powered by Random Forest Classifier")

st.markdown("""
This app analyzes sentiment based on a model trained on Wikipedia content for Austria.
""")

# Default sentence
default_sentence = "Austria is a stunning country with passionate people and rich culture."
...
# Footer
st.markdown("---")
st.markdown("📘 Model trained on Austria Wikipedia content using TextBlob + TF-IDF + SMOTE + Random Forest.")
st.markdown("👨‍💻 Created by *Vaishnavi*")
